...
debian-install-bluetooth:
	apt-get install -y --no-install-recommends rfkill bluetooth bluez-tools armv7-bluezalsa-osmc mosquitto-clients
...
dietpi-install-bluetooth:
	apt-get install -y --no-install-recommends rfkill bluetooth bluez-tools bluez-alsa-utils mosquitto-clients
